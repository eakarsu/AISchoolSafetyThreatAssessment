...
export default function GapLimitedAnonymousReportingTipsRouteExist() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-anonymous-reporting-tips-route-exist', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>Limited anonymous reporting (tips route exists, no public widget)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AISchoolSafetyThreatAssessment - Gap feature</p>
