...
const FEATURE_SLUG = 'limited-anonymous-reporting-tips-route-exist';
const FEATURE_TITLE = 'Limited anonymous reporting (tips route exists, no public widget)';
const PROJECT = 'AISchoolSafetyThreatAssessment';
